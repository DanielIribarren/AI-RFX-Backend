...
class ProposalPrompts:
    ...
    def get_prompt_with_branding(
        ...
        show_coordination = pricing_data.get('coordination_formatted', '$0.00') != '$0.00'
        show_tax = pricing_data.get('tax_formatted', '$0.00') != '$0.00'
        show_cost_per_person = pricing_data.get('cost_per_person_formatted', '$0.00') != '$0.00'
